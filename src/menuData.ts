export const menuData = {
    ...
    },
    {
      ...
      items: [
        ...
        },
        {
          ...
          description:
            'Jack Cheese, Grilled Onions, Served on Crumb Bros. Baguette',
          price: 9.75,
        },
        {
  ...
  fajitas: [
    {
      ...
      price: 10.95,
      servedWith:
        'red rice, black beans, grilled tomato salad, choice of corn or flour tortillas',
    },
    {
  ...
  tacos: [
    {
      ...
      price: 9.95,
      servedWith: 'red rice, black beans, corn & romaine salad, tortilla chips',
    },
    {
  ...
  enchiladas: [
    {
      ...
      options: [
        { type: 'Beef', uno: 8.5, dos: 9.95, tres: 11.5 },
        { type: 'Chicken', uno: 8.5, dos: 9.95, tres: 11.5 },
        { type: 'Cheese', uno: 8.5, dos: 9.95, tres: 11.5 },
        { type: 'Veggie', uno: 8.5, dos: 9.95, tres: 11.5 },
      ],
    },
    {
      name: 'Chili Relleno',
  ...
  quiche: [
    {
      name: 'Bacon, Swiss, and Mushroom Quiche',
